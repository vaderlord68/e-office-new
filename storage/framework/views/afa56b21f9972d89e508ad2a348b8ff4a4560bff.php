        ...
        <div class="col-md-12 col-xs-12 mgl5">
            ...
            <div class="col-md-2">
                <button id="btnSearch" class="btn btn-default smallbtn" style="padding-top: 4px"><span
                    ...
                    &nbsp;<?php echo e(Helpers::getRS($g,"Tim_kiem")); ?></button>
            </div>
        </div>
    </div>
    <div class="row ">
        ...
        <div class="col-md-12 mgt5">
            <div class="col-md-4 checkbox pull-left mgl10">
                <label>
                    ...
                    <p style="float: left;padding-left: 10px;"><?php echo e(Helpers::getRS($g,'Hien_thi_danh_muc_khong_su_dung')); ?></p>
                </label>
            </div>
            <div class=" col-md-7 pull-right alert alert-danger alert-dismissable hide">
                <i class="icon fa fa-ban"></i> <span id="err"><?php echo e(Helpers::getRS($g,"Co_loi_xay_ra_trong_qua_trinh_gui_du_lieu")); ?>
        ...
        $(document).ready(function () {
            ...
            function deleteRow(rowIndx, grid) {
                ...
                ask_delete(function(){
                    ...
                    postMethod('<?php echo e(url('W76F1555/view/'.$pForm.'/'.$g.'/delete')); ?>', function (res) {
            ...
            function update(rowIndx, grid) {
                ...
                if (grid.isDirty()) {
                    ...
                    if (rowD["CodeID"]=="" ) {
                        ...
                        grid.refreshRow({rowIndx: rowIndx});
                        grid.editFirstCellInRow({rowIndx: rowIndx});
                        validationCell(rowIndx,"CodeID",$grid,"<?php echo e(Helpers::getRS($g, 'Ban_chua_nhap')); ?>" + " " + "<?php echo e(Helpers::getRS($g, 'Ma')); ?>");
                        return false;
                    }
                    ...
                    if ( rowD["CodeName"]=="") {
                        ...
                        grid.refreshRow({rowIndx: rowIndx});
                        grid.editFirstCellInRow({rowIndx: rowIndx});
                        validationCell(rowIndx,"CodeName",$grid,"<?php echo e(Helpers::getRS($g, 'Ban_chua_nhap')); ?>" + " " + "<?php echo e(Helpers::getRS($g, 'Ten')); ?>");
                        return false;
                    }

                    var ID = $("#cboBlockIDW09F2022 option:selected").val();
                    postMethod('<?php echo e(url('W76F1555/view/'.$pForm.'/'.$g.'/UpdateData')); ?>', function (res) {
                        //setter
                        if (res != -1) {
                            $("#secW76F1555").find(".alert-danger").addClass('hide');
                            $("#gridW76F1555").pqGrid("option", "dataModel.data", res);
                            ...
                            $("#secW76F1555").find("#err").html('<?php echo e(Helpers::getRS($g,'Ma_nay_da_ton_tai')); ?>');
            ...
            var option = {
                    ...
                    items: [
                        {
                            type: 'button',
                            icon: 'fa fa-plus',
                            label: "<?php echo e(Helpers::getRS($g,"Them_moi1")); ?>",
                            listener: function () {
                                addRow(this);
                            }
                        }
                ...
                colModel: [
                    ...
                    , {
                        title: "<?php echo e(Helpers::getRS($g,'Ma')); ?>",
                        minWidth: 150,
                        width: 170,
                        dataType: "string",
                        dataIndx: "CodeID",
                    ...
                    , {
                        title: "<?php echo e(Helpers::getRS($g,'Ten')); ?>",
                        minWidth: 200,
                        width: 270,
                        dataType: "string",
                        dataIndx: "CodeName",
                    ...
                    , {
                        title: "<?php echo e(Helpers::getRS($g,'Ghi_chu')); ?>",
                        minWidth: 1,
                        width: 340,
                        dataType: "string",
                        dataIndx: "Remark",
                    ...
                    , {
                        title: "<?php echo e(Helpers::getRS($g,'STT')); ?>",
                        minWidth: 80,
                        width: 80,
                        dataType: "integer",
                    ...
                    , {
                        title: "<?php echo e(Helpers::getRS($g,'Mac_dinh')); ?>",
                        minWidth: 100,
                        width: 100,
                        dataType: "bool",
                        align: "center",
                    ...
                    , {
                        title: "<?php echo e(Helpers::getRS($g,'KSD')); ?>",
                        minWidth: 80,
                        width: 80,
                        dataType: "bool",
                        align: "center",
                    ...
                    switch (ui.dataIndx) {
                        case "CodeID":
                            if ((newVal.length == 0 && oldVal.length ==0 ) ||  newVal.length == 0    )              {
                                validationCell(ui.rowIndx,ui.dataIndx,$grid,"<?php echo e(Helpers::getRS($g, 'Ban_chua_nhap')); ?>" + " " + "<?php echo e(Helpers::getRS($g, 'Ma')); ?>");
                                return false;
                            }
                            var regex = /[^\w]/gi;
                            if (regex.test(ui.newVal) == true) {
                                validationCell(ui.rowIndx,ui.dataIndx,$grid,"<?php echo e(Helpers::getRS($g, 'Ma_co_ky_tu_khong_hop_le')); ?>");
                                return false;
                            }
                            if (newVal.length > 50)                        {
                                validationCell(ui.rowIndx,ui.dataIndx,$grid,"<?php echo e(Helpers::getRS($g, 'Gia_tri_vuot_qua_chieu_dai_cho_phep')); ?>");
                                return false;
                            }
                            break;
                        case "CodeName":
                            if ((newVal.length == 0 && oldVal.length ==0 ) ||  newVal.length == 0    )              {
                                validationCell(ui.rowIndx,ui.dataIndx,$grid,"<?php echo e(Helpers::getRS($g, 'Ban_chua_nhap')); ?>" + " " + "<?php echo e(Helpers::getRS($g, 'Ten')); ?>");
                                return false;
                            }
...
//            $("#gridW76F1555").pqGrid("option", "title", title);
                var type = $(this).val();
                postMethod('<?php echo e(url('W76F1555/view/'.$pForm.'/'.$g.'/loadgrid')); ?>', function (res) {
                    $("#gridW76F1555").pqGrid("option", "dataModel.data", res);
                    $("#gridW76F1555").pqGrid("refreshDataAndView");
