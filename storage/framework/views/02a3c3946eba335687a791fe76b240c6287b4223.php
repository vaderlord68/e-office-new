<?php $__env->startSection('news-wrapper'); ?>
    ...
    <span class="pull-right">
            <a href="<?php echo e(url('/w76f2141/edit?newsID='.$newsRow->NewsID)); ?>" title="<?php echo e(Helpers::getRS("Sua")); ?>">
    ...
    <div class="well pd">
        <label class="labell cut-detail"><?php echo e(Helpers::getRS("Tin_lien_quan")); ?></label>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <?php $__currentLoopData = $newRowDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a class="text-li"><?php echo e(isset($newDetail-> Title) ? $newDetail-> Title : ''); ?></a></li>
