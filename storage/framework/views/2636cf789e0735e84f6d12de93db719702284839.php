        ...
        <div class="card-body" id="modalW76F2141">
            <div id="bootstrap-data-table_wrapper"
                ...
                <form id="createNewsW76F2141" method="POST" action="/news/create/save" enctype="multipart/form-data">
                    ...
                    <div class="row mgb5">
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label class="lbl-normal"><?php echo e(Helpers::getRS("Bai_viet_lien_quan")); ?></label>
                        </div>
                        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                    ...
                    buttonList: [
                        {
                            ...
                            icon: "fa fa-save",
                            title: '<?php echo e(Helpers::getRS("Luu_va_dongU")); ?>',
                            enable: true,
                            hidden: false,
                            type: "button",
                        ...
                        , {
                            ...
                            postRender: function (ui) {
                                ui.$btn.click(function () {
                                    frmW76F2141Save();
                                    Window.location.href = '<?php echo e('/w76f2141'); ?>';
                                });
                            }
                        }
                        , {
