    ...
    <div class="header-menu">
        <div class="col-sm-10 pdl5 pdr5">
            <div class="inline">
                ...
                <a href="<?php echo e(url('/')); ?>"><img class="logo" src="<?php echo e(asset('media/logo-eOffice.png')); ?>" alt=""></a>
                    ...
                    <div class="dropdown for-notification">
                        ...
                        <div class="dropdown-menu" aria-labelledby="notification">
                            ...
                            <a class="dropdown-item media" href="/w76f2230">
                                <p><?php echo e(Helpers::getRS('Quan_ly_phong_hop')); ?></p>
                            </a>
                        </div>
                    </div>
                    <div class="dropdown for-notification">
        ...
        <div class="col-sm-2">
            <div class="user-area dropdown float-right">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle" src="<?php echo e(asset('media/default_user_icon.png')); ?>"
                         alt="User Avatar">
                </a>
