...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var rooms = <?php echo $carDList; ?>;
        console.log(rooms);
        var events = [
            {
                url: '<?php echo e(url('/W77F2000/loadCalender')); ?>',
                cache: false,
                method: 'post',
        ...
        $('#calendar').fullCalendar({
            ...
            select: function (start, end, jsEvent, view, resource) {
                ...
                showFormDialogPost("<?php echo e(url('/W77F2001/add')); ?>", 'myModal', data);
            ...
            eventClick: function (calEvent, resource) {
                ...
                if (!btnClickDel) {
                    ...
                    showFormDialogPost("<?php echo e(url('/W77F2001/edit')); ?>", 'myModal', data);
                    $('#calendar').fullCalendar('renderEvent', event, true); // stick? = true
                    $('#calendar').fullCalendar('unselect');
                }
                // }
