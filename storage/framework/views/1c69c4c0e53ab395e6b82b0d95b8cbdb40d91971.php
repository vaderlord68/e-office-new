    ...
    <script>
            ...
            $("#toolbarW76F2200").digiMenu({
                    ...
                    buttonList: [
                        ...
                        , {
                            ...
                            title: "<?php echo e(Helpers::getRS('Tim_kiem')); ?>",
                            enable: true,
                            hidden: function () {
                                return false;
                            },
                ...
                colModel: [
                    {
                        ...
                        editor: false,
                        render: function (ui) {
                            var str = '<a id="btnViewW76F2200" title="<?php echo e(Helpers::getRS("Xem")); ?>"><i class="fas fa-eye mgr10 text-primary cursor-pointer"></i></a>';
                        ...
                        postRender: function (ui) {
                            ...
                            $cell.find("#btnViewW76F2200").bind("click", function (evt) {
                                ...
                                window.location.href = "<?php echo e(url('/w76f2201/view')); ?>" + "?" + $.param(data);
                            });
                            $cell.find("#btnEditW76F2200").bind("click", function (evt) {
                                var data = {
                                    facilityID: rowData.FacilityID
                                }
                                window.location.href = "<?php echo e(url('/w76f2201/edit')); ?>" + "?" + $.param(data);
                            });
                            $cell.find("#btnDeleteW76F2200").bind("click", function (evt) {
                                ask_delete(function () {
                                    $.ajax({
                                        method: "POST",
                                        url: '<?php echo e(url('/w76f2200/delete')); ?>',
                                        data: {facilityID: rowData.FacilityID, _token: '<?php echo e(csrf_token()); ?>'},
        ...
        function loadDataW76F2200() {
           $("#gridW76F2200").pqGrid("showLoading");
            $.ajax({
                method: "POST",
                url: '<?php echo e(url("/w76f2200/filter")); ?>',
                data: $("#frmW76F2200").serialize()+  "&_token=<?php echo e(csrf_token()); ?>",
