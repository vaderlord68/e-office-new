                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                            ...
                            <textarea type="text" id="remarkW76F2141" name="remarkW76F2141" class="form-control"
                                      maxlength="2000"
                                      autocomplete="off" style="height: 60px"><?php echo e($remarkW76F2141); ?></textarea>
                                </div>
                            </div>
                            <div class="row mgb5">
                            ...
                            <div class="row mgb5">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                    <div class="input-group ">
                                        <input type="text" class="form-control" id="releaseDateW76F2141"
                                               name="releaseDateW76F2141" value="<?php echo e($releaseDateW76F2141); ?>"
                                               autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                    <input class="form-control" type="text" class="form-control" name="orderNoW76F2141"
                                           ...
                                           id="orderNoW76F2141" value="<?php echo e($orderNoW76F2141); ?>" placeholder=""
                                           autocomplete="off">
                                </div>
                            </div>
                            <div class="row mgb5">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" id="is_ShowBestNewsW76F2141"
                                                   ...
                                                   class="form-check-input"><?php echo e(Helpers::getRS("Tin_moi_nhat")); ?>
