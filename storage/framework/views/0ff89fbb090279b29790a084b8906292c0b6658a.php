<?php $__env->startSection('body_content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo e(Helpers::getRS('Them_moi_ban_tin')); ?></h4>
        </div>
                ...
                <form id="createNewsW76F2141" method="POST" action="/news/create/save" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <div class="row mgb5">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <a id="imgPreviewThumbnail"  href="<?php echo e(htmlentities($image)); ?>" data-toggle="lightbox" data-title="Thumbnail" data-footer="" >
                                        <img src="<?php echo e(htmlentities($image)); ?>" class="img-fluid">
                                    </a>
                                </div>
                            </div>
                            <div class="row mgb5">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="btn-group">
                                        <button id="btnChooseThumbnail" title="<?php echo e(Helpers::getRS('Chon_anh')); ?>" type="button" class="btn btn-default">---</button>
                                        <button id="btnPreviewThumbnail" title="<?php echo e(Helpers::getRS('Xem_anh')); ?>" type="button" class="btn btn-default"><i class="fa fa-eye"></i></button>
                                        <button id="btnRemoveThumbnail" title="<?php echo e(Helpers::getRS('Xoa_anh')); ?>" type="button" class="btn btn-default"><i class="fa fa-remove text-red"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                            <div class="row mgb5">
                                <div class="col-sm-2 col-md-2 col-lg-2 col-lg-2">
                                    <label class="lbl-normal" for=""><?php echo e(Helpers::getRS("Tieu_de")); ?></label>
                                </div>
                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                    <input type="text" name="titleW76F2141" id="titleW76F2141" class="form-control"
                                           autocomplete="off" value="<?php echo e($titleW76F2141); ?>" required>
                                </div>
                            </div>
                            <div class="row mgb5">
                                <div class="col-sm-2 col-md-2 col-lg-2 col-lg-2">
                                    <label class="lbl-normal" for=""><?php echo e(Helpers::getRS("Dien_giai")); ?></label>
                                </div>
                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                            <textarea type="text" id="remarkW76F2141" name="remarkW76F2141" class="form-control"
                                      autocomplete="off" style="height: 100px"><?php echo e($remarkW76F2141); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mgb5">
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label class="lbl-normal"><?php echo e(Helpers::getRS("Chuyen_muc")); ?></label>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <select name="channelIDW76F2141" id="channelIDW76F2141" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $channelIDList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channelIDItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($channelIDItem->CodeID); ?>" <?php echo e($channelIDItem->CodeID == $channelIDW76F2141 ? 'selected': ''); ?>><?php echo e($channelIDItem->CodeName); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                            <label class="lbl-normal"><?php echo e(Helpers::getRS("Tac_gia")); ?></label>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                            <input type="text" class="form-control" id="authorW76F2141" name="authorW76F2141" readonly
                                   class="form-control" value="<?php echo e($authorW76F2141); ?>" autocomplete="off">
                        </div>
                    </div>
                    <div class="row mgb5">
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 ">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" id="status_idW76F2141"
                                           ...
                                           <?php echo e($status_idW76F2141 == 1 ? 'checked': ''); ?> value="1"> <?php echo e(Helpers::getRS("Phat_hanh")); ?>
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <div class="form-group">
                                <label class="lbl-normal"><?php echo e(Helpers::getRS("Ngay_phat_hanh")); ?></label>
                            </div>
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <div class="input-group ">
                                <input type="text" class="form-control" id="releaseDateW76F2141"
                                       name="releaseDateW76F2141" value="<?php echo e($releaseDateW76F2141); ?>" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 ">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" id="is_hotnewsW76F2141"
                                           ...
                                           <?php echo e($is_hotnewsW76F2141 == 1 ? 'checked': ''); ?> value="1"><?php echo e(Helpers::getRS("Tin_noi_bat")); ?>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" id="is_ShowBestNewsW76F2141"
                                           ...
                                           <?php echo e($is_ShowBestNewsW76F2141 == 1 ? 'checked':''); ?>

                                           class="form-check-input"><?php echo e(Helpers::getRS("Dang_tai_ban_tin_moi_nhat")); ?>
                    ...
                    <div class="row mgb5">
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label class="lbl-normal"><?php echo e(Helpers::getRS('Tu_khoa')); ?></label>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <input type="text" name="keywordW76F2141" class="form-control" id="keywordW76F2141"
                                   placeholder="" autocomplete="off" value="<?php echo e($keywordW76F2141); ?>">
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <input class="form-control" type="text" class="form-control" name="orderNoW76F2141"
                                   ...
                                   id="orderNoW76F2141" value="<?php echo e($orderNoW76F2141); ?>" placeholder="" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="row mgb5">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <textarea type="text" id="contentW76F2141" name="contentW76F2141" required
                                      class="form-control"
                                      cols="10" rows="10" autocomplete="off"><?php echo e($contentW76F2141); ?></textarea>
                        </div>
                    </div>
                    <div class="row mgb5">
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <h4 class="lbl-normal-value"><?php echo e(Helpers::getRS("Bai_viet_lien_quan")); ?></h4>
                        </div>
                        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#btnRemoveThumbnail").click(function(){
                $("#image").val('');
                $('#imgPreviewThumbnail').attr('href', '<?php echo e(asset('media/no-photo.jpg')); ?>');
                $('#imgPreviewThumbnail').find("img").attr('src', '<?php echo e(asset('media/no-photo.jpg')); ?>');
            });
            ...
            $("#addNewsW76F2141").click(function () {
                showFormDialogPost('<?php echo e(url('/w76f2141/load-selectnews')); ?>', 'popW76F2141SelectNews', {_token: '<?php echo e(csrf_token()); ?>'}, null, null, function (res) {
                    //merge
            ...
            var obj = {
                ...
                colModel: [
                    ...
                    },
                    {
                        ...
                        align: "center",
                        render: function (ui) {
                            var str = '<a id="btnDeleteW76F2141" title="<?php echo e(Helpers::getRS("Xoa")); ?>"><i class="fa fa-remove text-red cursor-pointer"></i></a>';
                            return str;
                        },
                        postRender: function (ui) {
        ...
        $('#createNewsW76F2141').submit(function (e) {
            ...
            formData.append('newsID', '<?php echo e($newsID); ?>');
            ...
            if (task == "add") {
                url = '<?php echo e(url("/w76f2141/save")); ?>';
            }
            if (task == "edit") {
                url = '<?php echo e(url("/w76f2141/update")); ?>';
            }
            $.ajax({
