    ...
    public function index(Request $request, $task = "")
    {
        switch ($task) {
            case 'add':
                ...
                return view("system/module/Meeting/W76F2201/W76F2201", compact('logisticsList', 'coordinatorList', 'rowData', 'CreateUserID', 'divisionIDList', 'task'));
                break;
            case 'view':
            case 'edit':
                ...
                return view("system/module/Meeting/W76F2201/W76F2201", compact('rowData', 'task', 'channelIDList', 'divisionIDList', 'coordinatorList', 'logisticsList'));
                break;
            case 'save':
                try {
                    ...
                    $isBlackboardW76F2201 = \Helpers::sqlNumber($request->input('isBlackboardW76F2201', 1));
                    $isProjectorW76F2201 = \Helpers::sqlNumber($request->input('isProjectorW76F2201', 1));
                    $isEthernetW76F2201 = \Helpers::sqlNumber($request->input('isEthernetW76F2201', 1));
                    $isPCW76F2201 = \Helpers::sqlNumber($request->input('isPCW76F2201', 1));
                    $isMicrophoneW76F2201 = \Helpers::sqlNumber($request->input('isMicrophoneW76F2201', 1));
                    $isTeleConW76F2201 = \Helpers::sqlNumber($request->input('isTeleConW76F2201', 1));
