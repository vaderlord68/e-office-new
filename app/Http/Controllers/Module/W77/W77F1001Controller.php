    ...
    public function index(Request $request, $task = '') {
        ...
        switch ($task) {
            case 'add':
                ...
                return view("system/module/W77/W77F1001/W77F1001", compact('carTypes', 'carDrivers', 'task'));
                break;
            case 'view':
            case 'edit':
                ...
                return view("system/module/W77/W77F1001/W77F1001", compact('carTypes', 'carDrivers', 'rowData', 'task'));
                break;
            case 'save':
                try {
                    $data = [];
